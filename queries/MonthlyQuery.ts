...
export const MonthlyFundCountQuery = gql`
  query MonthlyFundCountQuery(
    $d0: BigInt!
    $d1: BigInt!
    $d2: BigInt!
    $d3: BigInt!
    ...
    m0: fundCounts(where: { timestamp_lt: $d0 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m1: fundCounts(where: { timestamp_lt: $d1 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m2: fundCounts(where: { timestamp_lt: $d2 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m3: fundCounts(where: { timestamp_lt: $d3 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m4: fundCounts(where: { timestamp_lt: $d4 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m5: fundCounts(where: { timestamp_lt: $d5 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m6: fundCounts(where: { timestamp_lt: $d6 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m7: fundCounts(where: { timestamp_lt: $d7 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m8: fundCounts(where: { timestamp_lt: $d8 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m9: fundCounts(where: { timestamp_lt: $d9 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m10: fundCounts(where: { timestamp_lt: $d10 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m11: fundCounts(where: { timestamp_lt: $d11 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
    m12: fundCounts(where: { timestamp_lt: $d12 }, orderBy: timestamp, orderDirection: desc, first: 1) {
      active
      nonActive
      timestamp
    }
